...
public class Constants {
  ...
  public static final String CASSANDRA_DATACENTER = System.getenv().getOrDefault("CASSANDRA_DATACENTER", "datacenter1");
  public static final String CASSANDRA_CONTACT_IP = System.getenv().getOrDefault("CASSANDRA_CONTACT_IP", "172.18.0.61");
  public static final int CASSANDRA_CONTACT_PORT = Integer.parseInt(System.getenv().getOrDefault("CASSANDRA_CONTACT_PORT", "9042"));
  public static final String CASSANDRA_REPLICATION_STRATEGY = System.getenv().getOrDefault("CASSANDRA_REPLICATION_STRATEGY", "SimpleStrategy");
  public static final int CASSANDRA_REPLICATION_FACTOR = Integer.parseInt(System.getenv().getOrDefault("CASSANDRA_REPLICATION_FACTOR", "1"));
