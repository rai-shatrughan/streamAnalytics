...
function drawVR() {
    const SCREEN_WIDTH = window.innerWidth,
			...
			function init() {
                ...
                var vrDom = document.getElementById('containerVR');
				vrDom.appendChild( renderer.domElement );

				vrDom.style.touchAction = 'none';
				vrDom.addEventListener( 'pointermove', onPointerMove );
